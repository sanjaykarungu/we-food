...
import imageData from './utilss/tea.json';
  ...
  return (
    <div className="w-full min-h-screen bg-amber-50 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 px-4 md:px-20">
        <div>
          <h1 className='font-bold text-4xl text-amber-900'>Tea</h1>
          <p className='font-bold text-xl mt-4 text-amber-800'>Taste these delectable classics, delightful tea to make your day.</p>
        </div>
        ...
        <div className="mt-6 md:mt-0 md:w-96">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search tea by name, place or price..."
              value={searchTerm}
