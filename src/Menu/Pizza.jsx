...
import imageData from './utilss/pizza.json';
...
const Pizza = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-red-50 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 px-4 md:px-20">
        <div>
          <h1 className='font-bold text-4xl text-red-800'>Pizza</h1>
          <p className='font-bold text-xl mt-4 text-red-700'>Taste these delectable classics, delectable pizza to make your day.</p>
        </div>
        ...
        <div className="mt-6 md:mt-0 md:w-96">
          <div className="relative">
            ...
            <input
              type="text"
              className="block w-full pl-10 pr-3 py-3 border border-red-300 rounded-lg bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
              placeholder="Search pizza by name, place or price..."
              value={searchTerm}
      ...
      <div className="pb-10 mt-10">
        {filteredData.length === 0 ? (
          <div className="text-center py-10">
            <p className="text-xl text-red-700">No pizza found matching your search.</p>
          </div>
        ) : (
