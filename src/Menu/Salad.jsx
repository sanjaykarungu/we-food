...
import imageData from "./utilss/salad.json"
  ...
  return (
    <div className="w-full min-h-screen bg-green-50 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 px-4 md:px-20">
        <div>
          <h1 className='font-bold text-4xl text-green-800'>Salad</h1>
          <p className='font-bold text-xl mt-4 text-green-700'>Taste these delectable classics, fresh salad to make your day.</p>
        </div>
        ...
        <div className="mt-6 md:mt-0 md:w-96">
          <div className="relative">
            ...
            <input
              type="text"
              className="block w-full pl-10 pr-3 py-3 border border-green-300 rounded-lg bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
              placeholder="Search salad by name, place or price..."
              value={searchTerm}
      ...
      <div className="pb-10 mt-10">
        {filteredData.length === 0 ? (
          <div className="text-center py-10">
            <p className="text-xl text-green-700">No salad found matching your search.</p>
          </div>
        ) : (
