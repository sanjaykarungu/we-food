...
import imageData from './utilss/burger..json';
    ...
    <div className="w-full min-h-screen bg-gray-50 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 px-4 md:px-20">
        <div>
          ...
          <p className='font-bold text-xl mt-4'>Taste these delectable classics, delectable burger is to make your day.</p>
        </div>
        ...
        <div className="mt-6 md:mt-0 md:w-96">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search burgers by name, place or price..."
              value={searchTerm}
      ...
      <div className="pb-10 mt-10">
        {filteredData.length === 0 ? (
          <div className="text-center py-10">
            <p className="text-xl text-gray-600">No burgers found matching your search.</p>
          </div>
        ) : (
            ...
            {filteredData.map((item, index) => (
              <div key={index} className="rounded-lg overflow-hidden shadow-lg bg-white transition-transform duration-300 hover:shadow-xl">
                ...
                <div className="p-4">
                  ...
                  <div className="text-orange-600 font-semibold mt-2">₹{item.price}</div>
                </div>
              </div>
            ))}
          </div>
