...
import imageData from './utils/masala.json';
  ...
  return (
    <div className="w-full min-h-screen bg-amber-50 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 px-4 md:px-20">
        <div>
          <h1 className='font-bold text-4xl text-amber-900'>Masalas and Dry Fruits</h1>
        </div>
        ...
        <div className="mt-6 md:mt-0 md:w-96">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search Masalas and Dry Fruits "
              value={searchTerm}
