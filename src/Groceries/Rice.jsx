...
import imageData from './utils/rice.json';
  ...
  return (
    <div className="w-full min-h-screen bg-amber-50 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 px-4 md:px-20">
        <div>
          <h1 className='font-bold text-4xl text-amber-900'>Rice, Atta and Dals</h1>
        </div>
        ...
        <div className="mt-6 md:mt-0 md:w-96">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search Rice, Atta and Dals"
              value={searchTerm}
            ...
            {filteredData.map((item, index) => (
              <div key={index} className="rounded-lg overflow-hidden shadow-lg bg-white transition-transform duration-300 hover:shadow-xl">
                <div>
                  ...
                  src={item.image}
                  alt={item.name}
                  className="w-full h-48  mt-1  hover:scale-105 transition-transform duration-300"
                />
                </div>
